...
class UrlsPage(BasePage):
    ...
    @qase.step("Проверь номер телефона на рыжей кнопке")
    ...
    @qase.step("Проверь номер телефона на рыжей кнопке в Екатеринбурге")
    ...
    @qase.step("Проверь номер телефона на рыжей кнопке в Новосибирске")
    ...
    @qase.step("Проверь номер телефона на рыжей кнопке в Краснодаре")
    ...
    @qase.step("Проверь номер телефона на рыжей кнопке в Ростове-на-Дону")
    ...
    @qase.step("Проверь номер телефона на рыжей кнопке в Омске")
    ...
    @qase.step("Проверь номер телефона на рыжей кнопке в Москве")
    ...
    @qase.step("Проверь номер телефона на рыжей кнопке в Спб")
...
class UrlsProviderPage(BasePage):
    ...
    @qase.step("Проверь номер телефона у провайдера Ростелеком в регионах")
    ...
    @qase.step("Проверь номер телефона у провайдера Ростелеком в Москве")
    ...
    @qase.step("Проверь номер телефона у провайдера Ростелеком в Санкт-Петербурге")
    ...
    @qase.step("Проверь номер телефона у провайдера МТС")
    ...
    @qase.step("Проверь номер телефона у провайдера Билайн")
    ...
    @qase.step("Проверь номер телефона у провайдера Дом-ру")
    ...
    @qase.step("Проверь номер телефона у провайдера ТТК")
    ...
    @qase.step("Проверь номер телефона у провайдера МГТС")
